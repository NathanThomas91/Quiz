...
class quiz:
    ...
    def welcome_screen(Self):
        l1 = Label(a, text = "Welcome in Quiz ", width = 54, bg = 'lightblue',fg = 'black', font = ('arial',30,'bold'))
        l1.place(x = 30, y = 40)
    ...
    def displaytitle(self, title):
        l1 = Label(a, text = title, width = 54, bg = 'darkblue',fg = 'black', font = ('arial',20,'bold'))
        l1.place(x = 5, y = 0)
    ...
    def sports1(self):
        ...
        global zyx
        global l1
        #self.l1.config(text = 'Sports Quiz')
        xyz = que1
        yxz = ans1
        zyx = opt1
        self.clear_frame()
    ...
    def technology1(self):
        ...
        global yxz
        global zyx
        #self.l1.config(text = 'Technology Quiz')
        xyz = que2
        yxz = ans2
        zyx = opt2
    ...
    def geography1(self):
        ...
        global zyx
        global abc
        #self.l1.config(text = 'Geography Quiz')
        xyz = que3
        yxz = ans3
        zyx = opt3
